  ...
  return (
        <ul>
          ...
          <li>
            <a
              href="#"
              className={`mb-1 px-2 py-2 rounded-lg flex items-center font-medium text-gray-700 hover:text-blue-600 hover:bg-gray-200 ${activeItem==='projects'?' bg-gray-200 text-blue-600':null}`}
            >
              <span className="mr-4 opacity-50">
              <FontAwesomeIcon
                icon={faPaste}
          ...
          <li>
            <a
              href="#"
              className={`mb-1 px-2 py-2 rounded-lg flex items-center font-medium text-gray-700 hover:text-blue-600 hover:bg-gray-200 ${activeItem==='posts'?' bg-gray-200 text-blue-600':null}`}
            >
